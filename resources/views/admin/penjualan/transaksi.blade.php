...
<section class="content-main">
    <div class="content-header">
      <h2 class="content-title">Transaksi Penjualan</h2>
    </div>
    <div class="card">
      <div class="card-body">
        <div class="row">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <td class="text-end">
                        ...
                        @endif
                        {{-- <a class="btn btn-sm font-sm rounded btn-danger mr-5" href="{{ route('admin.transaksi.detail', ['no_bukti' => $data->no_bukti]) }}">
                        ...
                        <div class="dropdown"><a class="btn btn-light rounded btn-sm font-sm" href="#" data-bs-toggle="dropdown"><i class="material-icons md-more_horiz"></i></a>
                            <div class="dropdown-menu">
                                ...
                                {{-- <a class="dropdown-item" href="#">Edit info</a><a class="dropdown-item text-danger" href="#">Delete</a> --}}
                            </div>
                          </div>
                        </td>
                     </tr>
