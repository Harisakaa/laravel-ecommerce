(function($) {
    ...
    function toggleP(bank, active) {
        let nomorTujuan = document.getElementById("nomorTujuan");
        let p = document.getElementById("nomorRek");

        if (active) {
            if (bank === "BNI") {
                nomorTujuan.innerText = "5264 3456 2200 0012";
            } else if (bank === "BRI") {
                nomorTujuan.innerText = "5521 7777 8421 2029";
            } else if (bank === "BCA") {
                nomorTujuan.innerText = "070 3213 3216 3";
            }
            nomorTujuan.style.color = "#B2C2E1";
            nomorTujuan.style.fontSize = "14px";
            nomorTujuan.style.lineHeight = "18px";
            nomorTujuan.style.fontWeight = "500";
            nomorTujuan.style.marginBottom = "10px";

            p.style.display = "block"; // Tampilkan elemen p jika aktif
        } else {
            p.style.display = "none"; // Sembunyikan elemen p jika tidak aktif
        }
    }
